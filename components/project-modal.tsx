...
export function ProjectModal({ project, onClose }: ProjectModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 md:p-6 overflow-y-auto">
      ...
      <div className="glass-strong relative z-10 my-auto flex flex-col w-full max-w-5xl max-h-[90vh] rounded-3xl shadow-2xl border border-border overflow-hidden">
        {/* Sticky Header: Status & Categories (Left) | Role Badge & Close Button (Right) */}
        <div className="sticky top-0 z-20 flex flex-wrap items-center justify-between gap-3 border-b border-border/60 bg-background/95 px-5 py-3.5 sm:px-8 sm:py-4 backdrop-blur-md">
          {/* Left: Status & Category Tags */}
          ...
          {/* Right: Role Badge & Close Button */}
          <div className="flex items-center gap-2.5 sm:gap-3">
            <div className="inline-flex items-center gap-1.5 rounded-full border border-border bg-card px-3.5 py-1.5 font-mono text-xs shadow-xs">
